...
import Headerleft from './components/headerleftcontent';
...
const DefaultMenu = dynamic(() => import('../../assets/js/defaultmenu.js'), {
    ssr: false,
});
export default function Dashbordtemplate({ children }) {
            ...
            <header className="header custom-sticky !top-0 !w-full">
                <nav className="main-header" aria-label="Global">
                    <div className="header-content">
                        <Headerleft isSidebarOpen={isSidebarOpen} setIsSidebarOpen={setIsSidebarOpen}/>
                        <HeaderRightContent />
                    </div>
                </nav>
            </header>
            <aside className={`app-sidebar ${isSidebarOpen ? 'open' : 'closed'}`} id="sidebar">
                <MainsidebarHeader />
                <MainSidebar />
            </aside>
                            ...
                            <div className="box overflow-hidden">
                                <div className="box-body">
                                    <div className="flex">
                                        ...
                                        <span className="badge bg-primary/10 text-primary py-1 ms-auto !my-auto">
                            ...
                            <div className="box overflow-hidden">
                                <div className="box-body">
                                    <div className="flex">
                                        ...
                                        <span className="badge bg-secondary/10 text-secondary py-1 ms-auto !my-auto">
                            ...
                            <div className="box overflow-hidden">
                                <div className="box-body">
                                    <div className="flex">
                                        ...
                                        <span className="badge bg-warning/10 text-warning py-1 ms-auto !my-auto">
                            ...
                            <div className="box overflow-hidden">
                                <div className="box-body">
                                    <div className="flex">
                                        ...
                                        <span className="badge bg-success/10 text-success py-1 ms-auto !my-auto">
